# International Autism Research: Comprehensive Brief for Hackathon App
...
### Diagnostic Criteria Differences: DSM-5 vs. ICD-11
...
### Countries with the Least Support
...
**Key Organizations**:
- **PANAACEA** (Argentine Program for Children, Adolescents, and Adults with Autism Spectrum Conditions) -- major research and advocacy organization
- **Red Espectro Autista Latinoamerica (REAL)** -- coalition of researchers/clinicians from 6 Latin American countries; conducted survey of 2,942 caregivers
- **Autism Speaks** has Spanish-language resources
- **NIMH** provides factsheets in Spanish ("Trastornos del espectro autista")
- **MedlinePlus en Español** has autism resources
...
**Philippines**:
- **Autism Society Philippines (ASP)** established 1989 -- 13,000 members across 97 chapters
- Government recognizes **National Autism Consciousness Week** (third week of January)
- Department of Health is mandated to formulate a National ASD Plan
- ASP offers family support groups, training, early detection consultancy, and free community-based therapy
...
**Bangladesh**:
- Services developed from 1990 in Dhaka hospitals; organizations like **SWAC** (Society for the Welfare of Autistic Children), **Autistic Welfare Foundation**, and **PROYASH** emerged from 2000 onward
- Community health worker models (like India's ASHAs) adapted to include autism-specific tools
- Bangladesh has used community education campaigns involving local leaders, teachers, and health workers to reduce stigma -- cited as a successful model
...
**Arabic Terminology**: ASD is commonly referred to in Arabic; resources exist in Arabic from organizations like Autism Speaks
...
([PMC Africa review](https://pmc.ncbi.nlm.nih.gov/articles/PMC10473371/); [PMC Sub-Saharan Africa](https://pmc.ncbi.nlm.nih.gov/articles/PMC6858850/); [PMC Somali knowledge study](https://pmc.ncbi.nlm.nih.gov/articles/PMC10851585/); [MPR News](https://www.mprnews.org/episode/2024/10/10/research-finds-1-in-16-somali-children-diagnosed-with-autism-three-times-more-than-state); [Sahan Journal](https://sahanjournal.com/health/autism-somali-new-terminology-community-acceptance-minnesota/))
...
Key tension points documented in research:
...
- Clinicians should "examine their own perspectives and beliefs about autism and keep a curious stance"
- Provide materials "translated in a **culturally competent context**, not just linguistically translated"
- Focus on coordination of care that crosses different systems
- Acknowledge that some families may focus treatment on behaviors facilitating family/community activities rather than individual skills
- Include community leaders, religious leaders, and elders in outreach
- Use **community health worker models** (like India's ASHAs or Bangladesh's model)
...
- **Significant cross-cultural validity problems**: In Sri Lanka, M-CHAT sensitivity was as low as **25%** in a Sinhalese population -- some behaviors considered red flags for autism were "not recognized as abnormal by Sinhalese mothers"
- **Japanese adaptation** had to account for reluctance to answer "yes" to yes/no questions and tendency to interpret lack of interest in other children as "shyness"
- **Moroccan Arabic adaptation** showed good performance after rigorous forward/backward translation
- **Brazilian adaptation** showed Cronbach alpha of 0.95, sensitivity 0.94, specificity 0.91
- **Spanish adaptation** validated on 2,480+ children in Spain
...
## 7. CRITICAL APP DESIGN IMPLICATIONS
...
7. **Provide resources for the whole family** -- collectivist cultures involve extended family in childcare. Grandparents and other relatives need information too, especially to bridge intergenerational gaps in understanding
